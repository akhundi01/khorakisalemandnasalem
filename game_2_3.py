...
SALEM_IMAGE = pygame.transform.scale(pygame.image.load("img/img/salem1.png"), (100, 100))
NASALEM_IMAGE = pygame.transform.scale(pygame.image.load("img/img/nasalem1.png"), (100, 100))
