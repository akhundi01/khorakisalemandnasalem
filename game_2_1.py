...
class App:
    def __init__(self):
        ...
        SALEM_IMAGE = pygame.transform.scale(pygame.image.load("img/img/salem{}.png".format(random.randrange(1, 9))), (140, 140))
        NASALEM_IMAGE = pygame.transform.scale(pygame.image.load("img/img/nasalem{}.png".format(random.randrange(1, 5))), (140, 140))
